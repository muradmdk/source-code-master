                    ...
                    <div className='w-full relative px-[15px] mx-auto sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px] 2xl:max-w-[1230px] border-b border-[#2f2f2f] pb-5  '>
                        ...
                        <div className='flex flex-wrap mx-[-15]'>
                            ...
                            <div className='w-[100%] max-w-[100%] flex-[100%] md:max-w-[50%] md:flex-[50%] lg:max-w-[33.333333%] lg:flex-[33.333333%] min-h-[1px] px-[15px]'>
                                ...
                                <div className='mb-6'>
                                    <p className='mt-3.5 text-white flex items-center text-[14px]'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-envelope text-[#a2c95c] mr-[5px]" viewBox="0 0 16 16">
                                    ...
                                    <p className='text-white flex items-center text-[14px]'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-envelope text-[#a2c95c] mr-[5px]" viewBox="0 0 16 16">
                                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z"></path>
                                        </svg>
                                        <Link href="">
                                ...
                                <div>
                                    <h2 className='text-[18px] text-white mb-[15px]'>Follow Us</h2>
                                    <ul className='flex items-center'>

                                        <li>
                                            <Link href="" className='flex items-center justify-center mr-3 size-8 bg-[#a2c95c]'>
                            ...
                            <div className='w-[100%] max-w-[100%] flex-[100%] md:max-w-[50%] md:flex-[50%] lg:max-w-[22%] lg:flex-[25%] min-h-[1px] px-[15px]'>
                                ...
                                <ul>
                                    ...
                                    <li className='mb-2.5'>
                                        <Link href="/contact-us" className='block text-white'>
                                            Contact Us
                                        </Link>
                                    </li>
