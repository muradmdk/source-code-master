            ...
            <div className='bg-[#f8f8f8] py-[60px]'>
                ...
                <div className='w-full max-w-[1230px] px-[15px] mx-auto'>
                    ...
                    <div className='w-[100%] max-w-[100%] flex-[100%] min-h-[1px]'>
                        <h2 className='text-[44px] relative tracking-normal leading-[1] block ml-0 mt-[40px] mb-[25px] font-bold'>
                            Nurture the <span className='text-[#a2c95c]'>Next Generation</span> of Excellence
                        </h2>

                        <h2 className='text-[28px] mb-5 font-normal leading-[1.15]'>
                    ...
                    <div className='flex items-center flex-wrap mx-[-15]'>
                        ...
                        <div className='w-[100%] max-w-[33.333333%] flex-[33.333333%] min-h-[1px] px-[15px]'>
                            <Link href="" className='border-[2px] border-[#DEDEDE] bg-white relative p-[25px] block text-[15px] mt-2.5 mb-[30px] about-link'>
                                <span className='text-[45px] text-[#3D3D3D] font-black leading-[1]'>01</span>
                                ...
                                <h2 className='text-[28px] text-[#a2c95c] mt-[45px] mb-[15px] font-bold'>
                                    The Thought
                                </h2>
                        ...
                        <div className='w-[100%] max-w-[33.333333%] flex-[33.333333%] min-h-[1px] px-[15px]'>
                            <Link href="" className='border-[2px] border-[#DEDEDE] bg-white relative p-[25px] block text-[15px] mt-2.5 mb-[30px] about-link'>
                                <span className='text-[45px] text-[#3D3D3D] font-black leading-[1]'>02</span>
                                <div className='absolute top-[15px] right-[20px]'>
                                    <Image
                        ...
                        <div className='w-[100%] max-w-[33.333333%] flex-[33.333333%] min-h-[1px] px-[15px]'>
                            <Link href="" className='border-[2px] border-[#DEDEDE] bg-white relative p-[25px] block text-[15px] mt-2.5 mb-[30px] about-link'>
                                <span className='text-[45px] text-[#3D3D3D] font-black leading-[1]'>03</span>
                                <div className='absolute top-[15px] right-[20px]'>
                                    <Image
